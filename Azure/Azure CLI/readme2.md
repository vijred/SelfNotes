...
* How to identify the details of logged in user -
```bash
# Your signed-in identity (object ID + UPN)
az ad signed-in-user show --query "{name:userPrincipalName, id:id}" -o table

# Capture the object ID for the commands below
ASSIGNEE=$(az ad signed-in-user show --query id -o tsv)
echo "Assignee objectId: $ASSIGNEE"
```
* 
