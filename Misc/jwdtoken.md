...
- Paste the token into https://jwt.ms/ (Alternative, use Powershell - https://github.com/vijred/SelfNotes/blob/master/Azure/Tools/SecurityTools.md#user-assigned-managed-identities )
