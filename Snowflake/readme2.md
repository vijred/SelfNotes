...
## Snowflake Role Grant Commands

### `SHOW GRANTS ON ROLE <role>`
Shows privileges granted **on the role object itself**.

**Answers:** Who can manage or own this role?

### `SHOW GRANTS TO ROLE <role>`
Shows privileges granted **to the role** on databases, schemas, tables, warehouses, and other objects.

**Answers:** What can this role access?

### `SHOW GRANTS OF ROLE <role>`
Shows users and roles that have been assigned this role.

**Answers:** Who has this role?

| Command | Purpose |
|----------|----------|
| `SHOW GRANTS ON ROLE <role>` | Who can manage/own the role? |
| `SHOW GRANTS TO ROLE <role>` | What permissions does the role have? |
| `SHOW GRANTS OF ROLE <role>` | Who has been assigned the role? |

### Quick Memory Aid
- **ON ROLE** → Permissions **on** the role
- **TO ROLE** → Permissions granted **to** the role
- **OF ROLE** → Users/roles that are members **of** the role
